...
function config (metricset, handler) {
  return {
    id: `moriohub_metrics_linux-morio-tap_${metricset}`,
    info: `This stream processor plugin will process metrics data from the ${metricset} metricset of the linux-morio-tap module.`,
    settings: {
      topics: ['metrics'],
      modules: ['linux-morio-tap'],
      datasets: [metricset],
      cache: {
        dflt: true,
