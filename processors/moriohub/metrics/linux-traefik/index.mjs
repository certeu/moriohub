...
function config (metricset, handler) {
  return {
    id: `moriohub_metrics_linux-traefik_${metricset}`,
    info: `This stream processor plugin will process metrics data from the ${metricset} metricset of the linux-traefik module.`,
    settings: {
      topics: ['metrics'],
