export default {
  cluster_stats: ({ data, formatNumber, formatBytes, lineChart }) => lineChart([
    // Docs
    {
      id: 'docs',
  ...
  index_summary: ({ data, formatNumber, formatBytes, lineChart }) => lineChart([
    // Docs
    {
      id: 'docs',
  ...
  "node": ({ data, lineChart, formatBytes }) => lineChart([
    {
      id: 'vvmmem',
  ...
  "node_stats": ({ data, formatBytes, formatNumber, lineChart }) => lineChart([
    // fs
    {
      id: 'ioops',
